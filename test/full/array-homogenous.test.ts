...
const ONE = 1
const MANY = 10
function testPackUnpackHomogeneousArray(
    element: any,
    count: number,
    expectedCompressionOffset?: number,
    roughly?: boolean,
) {
    const arr: any[] = []
...
describe('array-homogenous', function () {
    ...
    it('stringLongOne', function () {
        testPackUnpackHomogeneousArray(
    ...
    it('stringLongSingleQuotesOne', function () {
        testPackUnpackHomogeneousArray(
            "'aoasdfjalisruhgals'iuhfdlsajdlifuashrlifuhsaildjfsalkhglasurflasjdfklsandfasurliausnlc'",
            ONE,
        )
    })
    ...
    it('stringEscapeCharacterMultiple', function () {
        testPackUnpackHomogeneousArray(
            'aoasdfjalisruhgals\\\\iuhfdlsajdlifuashrlifuhsaildjfsalkhglas\\urflasjdfklsandfasurliausnlc',
            MANY,
        )
    })
