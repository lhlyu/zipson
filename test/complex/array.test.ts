...
const testCases = [
    new TestCase('empty', [], [ARRAY_START_TOKEN, ARRAY_END_TOKEN]),
    ...
    new TestCase(
        'repeated-repeated-many-repeated-not-repeated',
        [1, 1, 2, 2, 2, 2, 2, 3],
        [
            ARRAY_START_TOKEN,
            INTEGER_SMALL_TOKENS[INTEGER_SMALL_TOKEN_ELEMENT_OFFSET + 1]!,
    ...
    new TestCase(
        'one-object-one-string-one-number',
        [{ x: 1 }, 'hello', 2],
        [
            ARRAY_START_TOKEN,
            OBJECT_START_TOKEN,
    ...
    new TestCase(
        'shallow-template-object-non-object',
        [{ x: 1 }, { x: 2 }, 3],
        [
            ARRAY_START_TOKEN,
            TEMPLATE_OBJECT_START,
    ...
    new TestCase(
        'shallow-template-object-repeated',
