...
export const REGEX_ESCAPED_ESCAPE_CHARACTER = new RegExp(
    ESCAPE_CHARACTER.replace('\\', '\\\\') + ESCAPE_CHARACTER.replace('\\', '\\\\'),
    'g',
)
...
export const REGEX_UNREFERENCED_ESCAPED_STRING_TOKEN = new RegExp(
    ESCAPE_CHARACTER + ESCAPED_UNREFERENCED_STRING_TOKEN,
    'g',
)
...
export const INTEGER_SMALL_TOKENS = [
    'À',
    'Á',
    'Â',
    'Ã',
